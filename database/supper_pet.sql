...
INSERT INTO `users` (`id`, `name`, `avatar`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `role_id`) VALUES
(1, 'Quang', 'images\\avatar/Mylover.jpg', 'tvquang.19i@gmail.com', NULL, '$2y$10$Fb/73KD7ypL0OgCb1iBRpOCj4pp//VmHhgnEOE/SRkOVlf//ugNbi', NULL, '2022-11-14 07:38:00', '2022-11-14 07:38:00', 1);
...
--
ALTER TABLE `pet_detail`
  ADD CONSTRAINT `pet_detail_ibfk_1` FOREIGN KEY (`id_pet`) REFERENCES `pet` (`id`);
